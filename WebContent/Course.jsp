			...
			<%
				...
				for (int i = 0; i < al.size(); i++) {
					...
					out.write("<tr id='row" + i + "'><td>" + course.getCourse_id() + "</td> <td>" + course.getCourse_name()
							+ "</td>");
					out.write("<td batchNo='"+course.getBatch()+"'>" + batch_program.get(Integer.parseInt(course.getBatch())) + "</td> <td>"
							+ course.getNo_Of_Students() + "</td>");
					out.write("<td><button course_id='" + course.getCourse_id()
							+ "' class='btn btn-warning' type='button' data-toggle='modal' data-target='#myModal' id='editCourse"+(i+1)+"'>Edit</button> </td>");
	...
	<div class="modal-dialog">
		...
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title">Edit Course <span id="editCourseModalSpan"></span></h4>
			</div>
			<div class="modal-body">
				...
				<div class="form-group">
					<label class="control-label col-sm-4">Course Id</label>
					<div class="col-sm-6">
						<input id="edit_course_id" type="text" class="form-control" name="msg"
							placeholder="Course id">
					</div>
				</div>
				<div class="form-group">
